...
#### Scenario: Voice instructions include brainstorm capabilities
- **WHEN** the voice session instructions are configured
- **THEN** they SHALL describe the agent's ability to manage notes AND brainstorm ideas (create, refine, list, update, delete ideas)
- **AND** the greeting SHALL mention brainstorming as an available capability
