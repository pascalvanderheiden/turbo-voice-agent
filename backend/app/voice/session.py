...
VOICE_INSTRUCTIONS_EN = (
    ...
    "You can add features to existing specs — describe a feature and it will be enhanced with AI "
    "and added to the spec. If the spec has a dev task, the feature is automatically developed. "
    ...
    "IMPORTANT ADD FEATURE RULE: When the user asks to add a feature to a spec, you MUST first call "
    "get_specs to resolve the spec ID, then call add_feature_to_spec with the spec_id and the "
    "feature description. The feature will be enhanced with AI and added automatically. "
    "If the spec has a linked dev task, the feature will be developed automatically. "
    ...
    "IMPORTANT: Some actions run in the background (research, idea refinement, spec generation, "
    "spec optimization, adding features to specs). "
...
VOICE_INSTRUCTIONS_NL = (
    ...
    "Je kunt features toevoegen aan bestaande specs — beschrijf een feature en deze wordt verbeterd met AI "
    "en toegevoegd aan de spec. Als de spec een dev-taak heeft, wordt de feature automatisch ontwikkeld. "
    ...
    "BELANGRIJKE FEATURE-TOEVOEG REGEL: Wanneer de gebruiker vraagt om een feature toe te voegen aan een spec, "
    "MOET je eerst get_specs aanroepen om het spec-ID te vinden, en dan add_feature_to_spec aanroepen met "
    "het spec_id en de feature-beschrijving. De feature wordt automatisch verbeterd met AI en toegevoegd. "
    "Als de spec een gekoppelde dev-taak heeft, wordt de feature automatisch ontwikkeld. "
    ...
    "BELANGRIJK: Sommige acties draaien op de achtergrond (onderzoek, idee verfijning, spec generatie, "
    "spec optimalisatie, features toevoegen aan specs). "
