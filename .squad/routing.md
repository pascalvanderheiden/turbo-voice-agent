...
|-----------|----------|----------|
| Architecture & design decisions | Keaton 🏗️ | System design, refactoring strategy, API contracts |
| Backend / Python / FastAPI | Fenster 🔧 | Services, routes, agents, Cosmos DB, Voice Live |
| Agent orchestration / Supervisor | Fenster 🔧 | Agent tool definitions, function handlers, supervisor routing |
| Voice / WebSocket / Audio | Fenster 🔧 | Voice Live API, PCM streaming, turn detection |
| Frontend / Next.js / React | McManus ⚛️ | Pages, components, shadcn/ui, Tailwind, SSE streaming |
| Voice UI / frontend streaming | McManus ⚛️ | Voice hook, audio visualization, real-time UI |
| Mobile / React Native / Expo | Hockney 📱 | iOS app, Expo SDK, mobile voice, navigation |
